    ...
    <div id="content_wrap">
        ...
        <div class="cc-header">
            <h3>
                ...
                <span style="font-size:14px;float:right;color:#fff;padding-right:10px;display:none">
                    ...
                    <a class="btn btn-warning"  href="http://webriti.com/easy-coming-soon-pro-detail-page/" target="_new"><?php _e('Try Before Buy','');?></a>
